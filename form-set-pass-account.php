...
?>
<h4 class="user-data-header">Ustaw hasło</h4>
<div class="cnt-user-data">
    <form id="set-account" action="set-pass-account.php" class="col-12 col-xl-11" method="POST">
        ...
        <div class="wrapper-user-data row">
            <div class="name-user-data col-12 col-sm-4">Potwierdź hasło</div>
            <div class="box-user-data col-12 col-sm-8">
        ...
        <div class="wrapper-user-data row justify-content-end">
            <button type="submit" class="btn btn-primary col-12 col-sm-4 col-3">Ustaw hasło</button>
        </div>
    </form>
</div>